    ...
    <div className='flex flex-col '>
             ...
             <section>
        {
          listings?.map((item:Item, index)=>(
            <div key={index || item?.slug} className='w-fit md:h-96 h-1/4 flex md:flex-row font-sans flex-col md:justify-between md:m-8 mt-8'>
         ...
         <span className='font-semibold'>Pincode:</span>
           ...
           {item?.pincode}
            ...
            <button className='bg-blue-600 text-white rounded-md font-semibold  px-2 py-3'> Edit </button>
            </div>
            </div> 
          ))
        }
